//문제 출처 //문제 출처https://school.programmers.co.kr/learn/courses/30/lessons/1845
...
function solution(nums) {
    a = [... new Set(nums)].length //셋을 활용해서 중복 포켓몬을 없애주고 포켓몬 수를 센다.
    b = (nums.length)/2            //가져갈수 있는 포켓몬수를 샌다.
    var answer = Math.min(a,b)     //가져갈수 있는 포켓몬과 포켓몬 종류를 보고 더 작은 수를 고른다.
    return answer;
}